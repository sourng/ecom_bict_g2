...
$tbl_product_edit = NULL; // Initialize page object first

class ctbl_product_edit extends ctbl_product {
	...
	// Page object name
	var $PageObjName = 'tbl_product_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// pro_cat_id
			$this->pro_cat_id->SetDbValueDef($rsnew, $this->pro_cat_id->CurrentValue, NULL, $this->pro_cat_id->ReadOnly);

			// pro_name
			$this->pro_name->SetDbValueDef($rsnew, $this->pro_name->CurrentValue, NULL, $this->pro_name->ReadOnly);

			// pro_feature
			$this->pro_feature->SetDbValueDef($rsnew, $this->pro_feature->CurrentValue, NULL, $this->pro_feature->ReadOnly);

			// pro_img_folder
			$this->pro_img_folder->SetDbValueDef($rsnew, $this->pro_img_folder->CurrentValue, NULL, $this->pro_img_folder->ReadOnly);

			// pro_detail
			$this->pro_detail->SetDbValueDef($rsnew, $this->pro_detail->CurrentValue, NULL, $this->pro_detail->ReadOnly);

			// price
			$this->price->SetDbValueDef($rsnew, $this->price->CurrentValue, NULL, $this->price->ReadOnly);

			// pro_keyword
			$this->pro_keyword->SetDbValueDef($rsnew, $this->pro_keyword->CurrentValue, NULL, $this->pro_keyword->ReadOnly);

			// pro_status
			$tmpBool = $this->pro_status->CurrentValue;
			if ($tmpBool <> "Y" && $tmpBool <> "N")
				$tmpBool = (!empty($tmpBool)) ? "Y" : "N";
			$this->pro_status->SetDbValueDef($rsnew, $tmpBool, NULL, $this->pro_status->ReadOnly);

			// col_id
			$this->col_id->SetDbValueDef($rsnew, $this->col_id->CurrentValue, 0, $this->col_id->ReadOnly);
...
// Create page object
if (!isset($tbl_product_edit)) $tbl_product_edit = new ctbl_product_edit();

// Page init
$tbl_product_edit->Page_Init();

// Page main
$tbl_product_edit->Page_Main();
...
var CurrentForm = ftbl_productedit = new ew_Form("ftbl_productedit", "edit");
...
ftbl_productedit.Form_CustomValidate = 
...
ftbl_productedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftbl_productedit.Lists["x_pro_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftbl_productedit.Lists["x_pro_status[]"].Options = <?php echo json_encode($tbl_product_edit->pro_status->Options()) ?>;
...
?>
<form name="ftbl_productedit" id="ftbl_productedit" class="<?php echo $tbl_product_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tbl_product_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tbl_product_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tbl_product">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($tbl_product_edit->IsModal) ?>">
...
<p class="form-control-static"><?php echo $tbl_product->pro_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tbl_product" data-field="x_pro_id" name="x_pro_id" id="x_pro_id" value="<?php echo ew_HtmlEncode($tbl_product->pro_id->CurrentValue) ?>">
<?php echo $tbl_product->pro_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($tbl_product->pro_cat_id->Visible) { // pro_cat_id ?>
	<div id="r_pro_cat_id" class="form-group">
		<label id="elh_tbl_product_pro_cat_id" for="x_pro_cat_id" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->pro_cat_id->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->pro_cat_id->CellAttributes() ?>>
...
<?php if ($tbl_product->pro_name->Visible) { // pro_name ?>
	<div id="r_pro_name" class="form-group">
		<label id="elh_tbl_product_pro_name" for="x_pro_name" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->pro_name->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->pro_name->CellAttributes() ?>>
...
<?php if ($tbl_product->pro_feature->Visible) { // pro_feature ?>
	<div id="r_pro_feature" class="form-group">
		<label id="elh_tbl_product_pro_feature" for="x_pro_feature" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->pro_feature->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->pro_feature->CellAttributes() ?>>
...
<?php if ($tbl_product->pro_img_folder->Visible) { // pro_img_folder ?>
	<div id="r_pro_img_folder" class="form-group">
		<label id="elh_tbl_product_pro_img_folder" for="x_pro_img_folder" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->pro_img_folder->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->pro_img_folder->CellAttributes() ?>>
...
<?php if ($tbl_product->price->Visible) { // price ?>
	<div id="r_price" class="form-group">
		<label id="elh_tbl_product_price" for="x_price" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->price->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->price->CellAttributes() ?>>
...
<?php if ($tbl_product->pro_keyword->Visible) { // pro_keyword ?>
	<div id="r_pro_keyword" class="form-group">
		<label id="elh_tbl_product_pro_keyword" for="x_pro_keyword" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->pro_keyword->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->pro_keyword->CellAttributes() ?>>
...
<?php if ($tbl_product->pro_status->Visible) { // pro_status ?>
	<div id="r_pro_status" class="form-group">
		<label id="elh_tbl_product_pro_status" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->pro_status->FldCaption() ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->pro_status->CellAttributes() ?>>
...
<?php if ($tbl_product->col_id->Visible) { // col_id ?>
	<div id="r_col_id" class="form-group">
		<label id="elh_tbl_product_col_id" for="x_col_id" class="<?php echo $tbl_product_edit->LeftColumnClass ?>"><?php echo $tbl_product->col_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $tbl_product_edit->RightColumnClass ?>"><div<?php echo $tbl_product->col_id->CellAttributes() ?>>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tbl_product_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ftbl_productedit.Init();
</script>
<?php
...
<?php
$tbl_product_edit->Page_Terminate();
?>
