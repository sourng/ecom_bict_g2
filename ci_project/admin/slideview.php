...
fslideview.Lists["x_slide_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fslideview.Lists["x_slide_status[]"].Options = <?php echo json_encode($slide_view->slide_status->Options()) ?>;
...
<?php if ($slide->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_slide_image"><?php echo $slide->image->FldCaption() ?></span></td>
		<td data-name="image"<?php echo $slide->image->CellAttributes() ?>>
<span id="el_slide_image">
<span<?php echo $slide->image->ViewAttributes() ?>>
<?php echo $slide->image->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($slide->upload_date->Visible) { // upload_date ?>
	<tr id="r_upload_date">
		<td class="col-sm-2"><span id="elh_slide_upload_date"><?php echo $slide->upload_date->FldCaption() ?></span></td>
...
<?php echo $slide->upload_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($slide->delete_date->Visible) { // delete_date ?>
	<tr id="r_delete_date">
		<td class="col-sm-2"><span id="elh_slide_delete_date"><?php echo $slide->delete_date->FldCaption() ?></span></td>
...
<?php echo $slide->delete_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($slide->user_create->Visible) { // user_create ?>
	<tr id="r_user_create">
		<td class="col-sm-2"><span id="elh_slide_user_create"><?php echo $slide->user_create->FldCaption() ?></span></td>
...
<?php echo $slide->user_create->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($slide->slide_status->Visible) { // slide_status ?>
	<tr id="r_slide_status">
		<td class="col-sm-2"><span id="elh_slide_slide_status"><?php echo $slide->slide_status->FldCaption() ?></span></td>
...
<input type="checkbox" value="<?php echo $slide->slide_status->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $slide->slide_status->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
