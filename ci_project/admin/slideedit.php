...
class cslide_edit extends cslide {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// upload_date
			$this->upload_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->upload_date->CurrentValue, 0), NULL, $this->upload_date->ReadOnly);

			// delete_date
			$this->delete_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->delete_date->CurrentValue, 0), NULL, $this->delete_date->ReadOnly);
			...
			$this->slide_status->SetDbValueDef($rsnew, $tmpBool, NULL, $this->slide_status->ReadOnly);
...
fslideedit.Lists["x_slide_status[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fslideedit.Lists["x_slide_status[]"].Options = <?php echo json_encode($slide_edit->slide_status->Options()) ?>;
...
<?php if ($slide->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_slide_image" for="x_image" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->image->FldCaption() ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->image->CellAttributes() ?>>
...
<?php if ($slide->upload_date->Visible) { // upload_date ?>
	<div id="r_upload_date" class="form-group">
		<label id="elh_slide_upload_date" for="x_upload_date" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->upload_date->FldCaption() ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->upload_date->CellAttributes() ?>>
...
<?php if ($slide->delete_date->Visible) { // delete_date ?>
	<div id="r_delete_date" class="form-group">
		<label id="elh_slide_delete_date" for="x_delete_date" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->delete_date->FldCaption() ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->delete_date->CellAttributes() ?>>
...
<?php if ($slide->user_create->Visible) { // user_create ?>
	<div id="r_user_create" class="form-group">
		<label id="elh_slide_user_create" for="x_user_create" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->user_create->FldCaption() ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->user_create->CellAttributes() ?>>
...
<?php if ($slide->slide_status->Visible) { // slide_status ?>
	<div id="r_slide_status" class="form-group">
		<label id="elh_slide_slide_status" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->slide_status->FldCaption() ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->slide_status->CellAttributes() ?>>
