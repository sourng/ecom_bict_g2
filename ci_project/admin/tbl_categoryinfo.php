...
//
// Table class for tbl_category
//
class ctbl_category extends cTable {
	var $cat_id;
	var $cat_name;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_category';
		$this->TableName = 'tbl_category';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_category`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// cat_id
		$this->cat_id = new cField('tbl_category', 'tbl_category', 'x_cat_id', 'cat_id', '`cat_id`', '`cat_id`', 3, -1, FALSE, '`cat_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// cat_name
		$this->cat_name = new cField('tbl_category', 'tbl_category', 'x_cat_name', 'cat_name', '`cat_name`', '`cat_name`', 200, -1, FALSE, '`cat_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tbl_category`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "tbl_categoryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "tbl_categoryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tbl_categoryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tbl_categoryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tbl_categoryadd.php?" . $this->UrlParm($parm);
		else
			$url = "tbl_categoryadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tbl_categoryedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tbl_categoryadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_categorydelete.php", $this->UrlParm());
	}
