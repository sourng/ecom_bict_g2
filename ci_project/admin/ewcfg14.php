...
define("EW_PROJECT_ID", "{F31CE0FC-C728-4B81-A272-512B856E388F}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'IwCxddextVvz7s8X', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "ci_project", "qs" => "`", "qe" => "`");
