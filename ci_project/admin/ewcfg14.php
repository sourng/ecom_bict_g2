...
define("EW_PROJECT_ID", "{6AF8C2FF-A16C-4050-9229-E3A572D6C974}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'l0aCkc0SB6TlnNg7', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "group2", "qs" => "`", "qe" => "`");
